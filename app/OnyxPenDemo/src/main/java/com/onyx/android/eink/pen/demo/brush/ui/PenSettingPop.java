package com.onyx.android.eink.pen.demo.brush.ui;
...
import com.onyx.android.eink.pen.demo.brush.data.ShapeTexture;
import com.onyx.android.eink.pen.demo.brush.data.ShapeType;
import com.onyx.android.eink.pen.demo.brush.data.StrokeColor;
...
public class PenSettingPop extends BasePopup {
    ...
    private void updateStrokeWidthImpl(final float lineWidth) {
        PenCommands.applyStrokeWidth(getPenBundle(), getPenManager(), getCurrentShapeType(), lineWidth);
    }
    ...
    public class BrushSettingAdapter extends RecyclerView.Adapter<BrushSettingAdapter.ViewHolder> {
        ...
        private void onBrushSettingImpl(ShapeType shapeType) {
            ...
            PenCommands.applyStrokeStyle(getPenBundle(), getPenManager(),
                            selectedShapeType.getValue(), getPenBundle().getCurrentTexture())
                    .subscribe(pm -> {
                        initSeekBar();
                        initTextureList();
    ...
    public class ColorSettingAdapter extends RecyclerView.Adapter<ColorSettingAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                PenCommands.applyStrokeColor(getPenBundle(), getPenManager(), selectedStrokeColor.getValue());
                notifyDataSetChanged();
            });
        }
    ...
    public class TextureSettingAdapter extends RecyclerView.Adapter<TextureSettingAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                notifyDataSetChanged();
                PenCommands.applyStrokeStyle(getPenBundle(), getPenManager(),
                        getPenBundle().getCurrentShapeType(), selectedShapeTexture.getTexture())
                        .subscribe();
            });
        }
